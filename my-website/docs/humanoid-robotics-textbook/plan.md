...
**Target Platform**: Local or cloud workstations (for development and simulation), Jetson Orin (for edge deployment considerations in relevant sections).
**Project Type**: Documentation/Book (Docusaurus static site generator)
**Performance Goals**: Accurate simulation with physics & sensor fidelity; Realistic perception and navigation pipelines; Reproducible code & examples; Efficient loading of Docusaurus site.
